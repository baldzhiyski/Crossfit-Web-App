...
public interface EmailService {
    ...
    void sendUserLoggedViaGitHubEmailWithRawRandomPass(UUID uuid, String username, String fullName, String email, String currentPassword, String address, Date dateOfBirth);
}
